        ...
        <SafeAreaView style={{ backgroundColor: "#1a202c", flex: 1 }}>
            <ScrollView contentContainerStyle={{ paddingTop: 25, }}>
                <View style={{ paddingHorizontal: 25 }}>
                    <Text style={{ color: "white", fontSize: 24, fontWeight: "bold", marginBottom: 10 }}>Automate BTC</Text>
                    ...
                    <DropShadow style={styles.shadowPropBlack}>
                        <View style={{
                            ...
                            <Text style={{ color: "white", fontWeight: "bold", textAlign: "center", marginBottom: 25 }}>Capital Disponible: 0.00083257 BTC</Text>
