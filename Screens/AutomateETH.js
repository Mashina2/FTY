        ...
        <SafeAreaView style={{ backgroundColor: "#1a202c", flex: 1, position: "relative", }}>
                        ...
                        <Animatable.View
                            ...
                            <View style={{ marginTop: 20 }}>
                                <View style={{ marginBottom: 10 }}>
                                    <Text style={{ color: "white", fontSize: 12, fontFamily: "Montserrat-Medium", }}>Montant disponible 0.000000000 ETH</Text>
                                </View>
                                <View style={{ marginBottom: 10 }}>
                                    <Text style={{ color: "white", fontSize: 12, fontFamily: "Montserrat-Medium", }}>Montant normal acceptable 0.000000000 ETH</Text>
                                </View>
                                <Slider
                                    value={stateValue}
            ...
            <ScrollView contentContainerStyle={{ paddingTop: 25, }}>
                <View style={{ paddingHorizontal: 25 }}>
                    <Text style={{ color: "white", fontSize: 20, fontFamily: "Montserrat-Medium", marginBottom: 10 }}>Automate ETH</Text>
                    ...
                    <DropShadow style={styles.shadowPropBlack}>
                        <View style={{
                            ...
                            <Text style={{ color: "white", fontFamily: "Montserrat-Medium", textAlign: "center", marginBottom: 25 }}>Capital Disponible: 0.00083257 ETH</Text>
